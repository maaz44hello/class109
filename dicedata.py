...
#finding first standard deviation start and end values,and second standard deviation start and end value 
...
#ploting the chart and line for mean one standard deviation and 2 standard deviation
